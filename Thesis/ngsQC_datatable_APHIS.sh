...
# bash ngsQC_datatable_APHIS.sh /Users/christiewoodside/Desktop/Thesis/H5N1/mar9/ngs/ /Users/christiewoodside/Desktop/Thesis/H5N1/mar9/ngs/ngs_peridomestic_march9.tsv
...
print(bsMeta('$BIOSAMPLE_ID', 0.75))")
            ...
            echo -e "$ORGANISM\tNo matching SRA found\t\t\t\tv1.6" >> "$output_file"
        fi
    done
